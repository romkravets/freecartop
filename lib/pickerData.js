...
export const PURPOSES = [
  {
    key: "daily",
    emoji: "🏙",
    label: "Щодня по місту",
    desc: "Основне авто, пробки, парковка",
  },
  {
    key: "family",
    emoji: "👨‍👩‍👧",
    label: "Сімейне авто",
    desc: "Дітки, поїздки, багаж",
  },
  {
    key: "offroad",
    emoji: "🏔",
    label: "Позашляховик",
    desc: "Погані дороги, виїзди на природу",
  },
  {
    key: "status",
    emoji: "✨",
    label: "Статус / комфорт",
    desc: "Бізнес, представницьке авто",
  },
  {
    key: "economy",
    emoji: "💼",
    label: "Мінімум витрат",
    desc: "Дешево обслуговувати, мало їздити",
  },
];
...
export const BODY_TYPES = [
  {
    ...
    emoji: "🚗",
    label: "Седан",
    desc: "Класика, хороша керованість",
  },
  {
    key: "suv",
    emoji: "🚙",
    label: "Кросовер / SUV",
    desc: "Висока посадка, простір",
  },
  {
    key: "hatch",
    emoji: "🚘",
    label: "Хетч / Комбі",
    desc: "Містко і маневрено",
  },
  {
    key: "minivan",
    emoji: "🚐",
    label: "Мінівен",
    desc: "Максимум пасажирів і вантажу",
  },
];
...
export const FUELS = [
  {
    ...
    emoji: "⛽",
    label: "Бензин",
    desc: "Дешевше ТО, менше ризику взимку",
  },
  {
    key: "diesel",
    emoji: "🛢",
    label: "Дизель",
    desc: "Економніший на трасі, дорожче обслуговування",
  },
  {
    key: "hybrid",
    emoji: "🔋",
    label: "Гібрид",
    desc: "Менше витрати в місті",
  },
  {
    key: "electric",
    emoji: "⚡",
    label: "Електро",
    desc: "Нульові витрати на пальне",
  },
];
...
export const PRIORITIES = [
  {
    ...
    emoji: "🔧",
    label: "Надійність",
    desc: "Не хочу до СТО щомісяця",
  },
  {
    key: "economy",
    emoji: "💰",
    label: "Економія",
    desc: "Мінімум витрат на пальне і ТО",
  },
  {
    key: "comfort",
    emoji: "🛋",
    label: "Комфорт",
    desc: "Тиша, м'яка підвіска, простір",
  },
  {
    key: "dynamics",
    emoji: "🏎",
    label: "Динаміка",
    desc: "Спортивний стиль водіння",
  },
  {
    key: "safety",
    emoji: "🛡",
    label: "Безпека",
    desc: "Максимальна пасивна і активна безпека",
  },
];
...
export const CARS = [
  // ════════ MICRO BUDGET ════════
  {
    ...
    pros: [
      "Легендарна надійність",
      "Дешеве ТО",
      "Запчастини скрізь",
      "Помірний пробіг за вік",
    ],
    cons: ["Скромний салон", "Слабка динаміка", "Багато на ринку битих"],
    watchOut: [
      "Перевір поперечні важелі",
      "Іржа під капотом у старших",
      "Дивись пробіг — класика для скручування",
    ],
    icon: "🇯🇵",
  },
  {
    ...
    pros: [
      "Просторий салон за гроші",
      "Комбі-версія ідеальна для родини",
      "Зручний у трафіку",
    ],
    cons: [
      "Дорожчий ремонт за японців",
      'VAG "хвороби" — DSG, пневма',
      "Іржа порогів",
    ],
    watchOut: [
      "Уникай DSG (автомат) у старших",
      "Перевір пневмопідвіску",
      "DSG до 2009 — ненадійна",
    ],
    icon: "🇨🇿",
  },
  {
    ...
    watchOut: [
      "Іржа арок і порогів",
      "Перевір підвіску — стуки типові",
      "Пробіг — популярна для скручування",
    ],
    icon: "🇯🇵",
  },
  ...
  // ════════ MID BUDGET ════════
  {
    ...
    pros: [
      "Найнадійніший седан у класі",
      "Просторий і комфортний",
      "Дешевий у обслуговуванні",
      "Великий попит при перепродажу",
    ],
    cons: [
      "Розмитий дизайн",
      "Посередня динаміка",
      "Завищена ціна через репутацію",
    ],
    watchOut: [
      "Мотор 2.4 — слабке місце масло в охолодженні",
      "Типова іржа порогів",
      "Автомат — перевір роботу",
    ],
    icon: "🇯🇵",
  },
  {
    ...
    pros: [
      "Хороший клас за гроші",
      "Повний привід доступний",
      "Зручний для родини",
    ],
    cons: [
      "Дизель — капризний на холоді",
      "Ланцюг ГРМ — перевіряй",
      "Пластик салону простуватий",
    ],
    watchOut: [
      "Ланцюг ГРМ мотора 2.0 — міняй до 150k",
      "Іржа рами у старших",
      "Гальмівні суппорти — типова проблема",
    ],
    icon: "🇰🇷",
  },
  {
    ...
    pros: [
      "Відмінне співвідношення ціна/комфорт",
      "Просторний багажник",
      "Приємна керованість",
    ],
    cons: [
      "DSG — ненадійна до 2015",
      "Коксування мотора TSI",
      "Дорогий ремонт у VAG-сервісах",
    ],
    watchOut: [
      'DSG 7 (DQ200) — "суха" — уникай',
      "TSI мотори — коксування клапанів",
      "Перевір підтікання масла",
    ],
    icon: "🇨🇿",
  },
  {
    ...
    pros: [
      "Дуже надійний",
      "Повний привід без проблем",
      "Популярний — легко знайти СТО",
    ],
    cons: [
      "Гамірний на швидкості",
      "Дорожнє просвітлення середнє",
      "Простий салон",
    ],
    watchOut: [
      "Іржа кузова у старших",
      "Перевір AWD муфту",
      "Пробіг — популярний для скручування",
    ],
    icon: "🇯🇵",
  },
  ...
  // ════════ UPPER BUDGET ════════
  {
    ...
    pros: [
      ...
      "Розкішний салон",
      "Безпека 5★ NCAP",
      "Гібрид — 5–6 л/100 в місті",
    ],
    cons: [
      "Висока ціна для об'єму",
      "Гібрид — дорожчий ремонт акумулятора з часом",
      "Спортивне водіння — не про нього",
    ],
    watchOut: [
      "Ціна вища за ринок — торгуйся",
      "Перевір ДТП через VIN",
      "Гібрид — стан батареї",
    ],
    icon: "🇯🇵",
  },
  {
    ...
    pros: [
      "Надійний повний привід",
      "Просторий і практичний",
      "Гарний ресурс двигуна",
    ],
    cons: [
      "Нудний дизайн 2013–2015",
      "Жорсткувата підвіска",
      "Зростаюча ціна через попит",
    ],
    watchOut: [
      "CVT автомат — перевір роботу",
      "Іржа порогів у першого покоління",
      "Пробіг",
    ],
    icon: "🇯🇵",
  },
  {
    ...
    watchOut: [
      "DSG 7 (DQ200) — обов'язково перевір",
      "TSI мотор — коксування",
      "Пневмопідвіска — дорога",
    ],
    icon: "🇨🇿",
  },
  {
    ...
    watchOut: [
      "DSG — перевіряй",
      "Типова іржа порогів Passat",
      "Сервісна книжка обов'язкова",
    ],
    icon: "🇩🇪",
  },
  ...
  // ════════ PREMIUM BUDGET ════════
  {
    ...
    pros: [
      "Нове покоління — агресивний дизайн",
      "Найкращий клас безпеки",
      "Надійний гібрид 40 MPG",
      "Великий ресурс",
    ],
    cons: ["Висока ціна", "CVT гібрида — специфіка", "Запчастини поки дорогі"],
    watchOut: [
      "Перевір VIN — популярний для ДТП",
      "Дивись стан батареї гібрида",
    ],
    icon: "🇯🇵",
  },
  {
    ...
    pros: [
      "Розкішний салон нового покоління",
      "Безпека 5★",
      "Гібрид — дуже економний",
      "Легендарна надійність Toyota",
    ],
    cons: ["Максимальна ціна в класі", "Тільки для тих кому не потрібен SUV"],
    watchOut: [
      "Ринок UA — часто з США, перевіряй CARFAX",
      "Гібрид — стан батареї",
    ],
    icon: "🇯🇵",
  },
  {
    ...
    pros: [
      "Топовий дизайн нового покоління",
      "Технологічний салон",
      "Повний набір безпеки",
    ],
    cons: [
      "Ще молодий — мало відгуків про ресурс",
      "Дорогий",
      "Підвіска трохи жорстка",
    ],
...
export function pickCars(prefs) {
  ...
  const scored = CARS.map((car) => {
    ...
    // Total scores bonus
    const avg =
      Object.values(ps).reduce((a, b) => a + b, 0) / Object.values(ps).length;
    score += avg * 1.5;

    return {
      ...car,
      _score: score,
      _matches: { budgetMatch, purposeMatch, bodyMatch, fuelMatch },
    };
  });
